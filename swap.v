...
Definition _j : ident := 49%positive.
...
Definition _swap : ident := 52%positive.
      ...
      (Sassign
        (Ederef
          (Ebinop Oadd (Etempvar _a (tptr tint)) (Etempvar _i tint)
            (tptr tint)) tint) (Etempvar _t2 tint))
      (Sassign
        (Ederef
          (Ebinop Oadd (Etempvar _a (tptr tint)) (Etempvar _j tint)
            (tptr tint)) tint) (Etempvar _t1 tint)))))
|}.
...
(Ssequence
  (Scall None
    (Evar _swap (Tfunction (Tcons (tptr tint) (Tcons tint (Tcons tint Tnil)))
                  tvoid cc_default))
    ((Evar _four (tarray tint 4)) :: (Econst_int (Int.repr 1) tint) ::
...
((___builtin_fabs,
 ...
 (___builtin_write32_reversed,
   Gfun(External (EF_builtin ___builtin_write32_reversed
     ...
     tvoid cc_default)) :: (_swap, Gfun(Internal f_swap)) ::
 (_four, Gvar v_four) :: (_main, Gfun(Internal f_main)) :: nil);
prog_public :=
(_main :: _four :: _swap :: ___builtin_write32_reversed ::
